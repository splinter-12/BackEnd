...
public class S2s1RestController {
    @Autowired
    ...
    @PostMapping("/import-s2s1")
    public Map<String, Object> uploadFileS2s1(@RequestBody Map<String, Object> toBeImported) {
        ...
        try {
            ...
            try {
                ...
                for (ArrayList<String> studentLine : studentLines) {
                    ...
                    student.setCodeSemestre(semesterService.getAll().get(1).getCode());
                    student.setTitreSemestre(semesterService.getAll().get(1).getTitre());
                    ...
                    markService.save(new Mark(null,
                            element1.getNote(), "S1", elementService.findByCode(element1.getCode()),
                    ...
                    markService.save(new Mark(null,
                            element2.getNote(), "S1", elementService.findByCode(element2.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    markService.save(new Mark(null,
                            element3.getNote(), "S1", elementService.findByCode(element3.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    markService.save(new Mark(null,
                            element4.getNote(), "S1", elementService.findByCode(element4.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    markService.save(new Mark(null,
                            element5.getNote(), "S1", elementService.findByCode(element5.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    markService.save(new Mark(null,
                            element6.getNote(), "S1", elementService.findByCode(element6.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    markService.save(new Mark(null,
                            element7.getNote(), "S1", elementService.findByCode(element7.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    markService.save(new Mark(null,
                            element8.getNote(), "S1", elementService.findByCode(element8.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    markService.save(new Mark(null,
                            element9.getNote(), "S1", elementService.findByCode(element9.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    markService.save(new Mark(null,
                            element10.getNote(), "S1", elementService.findByCode(element10.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    markService.save(new Mark(null,
                            element11.getNote(), "S1", elementService.findByCode(element11.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    module7.getElements().add(element12);

                    markService.save(new Mark(null,
                            element12.getNote(), "S1", elementService.findByCode(element12.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    markService.save(new Mark(null,
                            element13.getNote(), "S1", elementService.findByCode(element13.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));
                    ...
                    module7.setCode(moduleService.findByElement(new ma.ensetm.project.
                            entities.Element(null, element12.getCode(), element12.getTitre(), 0f, 0f, null, null)).getCode());
                    ...
                    module8.setNote(0f);
                    module8.setResultat("");
                    module8.setElements(new ArrayList<>());
                    ...
                    module8.getElements().add(element14);

                    markService.save(new Mark(null,
                            element14.getNote(), "S1", elementService.findByCode(element14.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));

                    Element element15 = new Element();
                    element15.setTitre(elements.get(14).split("-")[1].trim());
                    element15.setCode(elements.get(14).split("-")[0].trim());
                    element15.setNote(Float.parseFloat(studentLine.get(31).replace(",", ".")));
                    element15.setBareme(Float.parseFloat(studentLine.get(32)));
                    element15.setPonderation(elementService.findByCode(element15.getCode()).getPonderation());
                    module8.getElements().add(element15);

                    markService.save(new Mark(null,
                            element15.getNote(), "S1", elementService.findByCode(element15.getCode()),
                            studentService.findById(Long.parseLong(studentLine.get(0)))));


                    //
                    module8.setCode(moduleService.findByElement(new ma.ensetm.project.
                            entities.Element(null, element14.getCode(), element14.getTitre(), 0f, 0f, null, null)).getCode());
                    module8.setTitre(moduleService.findByElement(new ma.ensetm.project.
                            entities.Element(null, element15.getCode(), element15.getTitre(), 0f, 0f, null, null)).getTitre());
                    //
                    ...
                    student.getModules().add(module8);
    ...
    @PostMapping("/export-s2s1")
    public Map<String, Object> exportForS2s1(@RequestBody Data output, @RequestParam(required = false, defaultValue = "true") String avecElement) {
        ...
        try {
            theSavedFile = new FileInputStream(new File(new File("").getAbsolutePath() + "/templates/TemplateS2S1.xls"));
        ...
        try {
            DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy-HH-mm-ss");
            String name = "S2S1-" + dateFormat.format(new Date()) + ".xls";
